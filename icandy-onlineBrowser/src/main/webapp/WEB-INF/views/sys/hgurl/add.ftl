<form class="form required-validate" method="post" action="${ctx!}/hgurl/addAction" onsubmit="return validateCallback(this, dialogAjaxDone)">
<table class="table table-bordered">
	<tr>
		<th class="col-sm-3">皇冠地址</th>
		<td class="col-sm-9"><div class="input-group">
			<input class="form-control" name="hgurl" type="text" required>
